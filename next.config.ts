...
/**
 * Next.js config — performance + URL preservation.
 *
...
const nextConfig: NextConfig = {
	...
	async headers() {
		// Long-cache static images and fonts under /public. Next.js already
		// emits immutable Cache-Control for /_next/static hashed assets, so
		// only the user-facing /public paths need an override here.
		return [
			{
