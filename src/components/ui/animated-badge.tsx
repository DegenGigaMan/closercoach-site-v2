...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative flex max-w-fit items-center justify-center gap-3 rounded-full border border-[#10B981]/20 bg-[#10B981]/8 px-4 py-1.5 text-cc-text-secondary backdrop-blur-sm transition-colors"
    >
      ...
      <span className="text-base font-medium text-cc-text-secondary">{text}</span>
    </motion.div>
  )
  return (
    <>
